...
export const modifyAvailableTime: IApi = async (req, res) => {
  try {
    ...
    const _result = await updateMentorAvailableTime({
      mentorId: userId,
      availableTimeList,
    });
...
export const updateMentorInfoController: IApi = async (req, res) => {
  try {
    ...
    const _result = await updateMentorInfo({
      userId,
      data,
    });
...
export const updateDisciplinesController: IApi = async (req, res) => {
  try {
    ...
    const _result = await updateDisciplines({
      userId,
      disciplines,
    });
...
export const updateSkillsController: IApi = async (req, res) => {
  try {
    ...
    const _result = await updateSkills({
      userId,
      skills,
    });
...
export const updateToolsController: IApi = async (req, res) => {
  try {
    ...
    const _result = await updateTools({
      userId,
      tools,
    });
